...
def reset_clicked():
    reset_game()
#create reset button    
reset_btn = Button(window, text="Reset", bg="lightgrey", fg="black", width=8, height=1, font=('Helvetica','12'), command=reset_clicked)
reset_btn.grid(column=2, row=4, columnspan=2)
